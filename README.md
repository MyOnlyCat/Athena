...
- **Athena-Node：部分完成。** 已具备管理员认证、SSH 主机管理、网页终端、SFTP
  ...
  完成集成验证与后续迭代。
- **Athena-Master：基础应用、管理员管理和注册生命周期已完成。** 已具备可迁移的 SQLite
  数据库、初始化管理员登录、管理员账号维护、两阶段 Node 注册审批、拒绝/恢复、自动
  过期清理、注册限流与 Token 唯一性保护、健康检查、中文
  管理界面和 Windows 本地启动入口；认证心跳与资产汇总待实现。
